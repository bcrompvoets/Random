...
inp_va, tar_va = replicate_data_single(X_va, Y_va,\
     [len(np.where(Y_va==0.)[0]),len(np.where(Y_va==1.)[0]),len(np.where(Y_va==2.)[0]),len(np.where(Y_va==3.)[0]),len(np.where(Y_va==4.)[0])])
...
inp_te, tar_te = replicate_data_single(X_te, Y_te,\
      [len(np.where(Y_te==0.)[0]),len(np.where(Y_te==1.)[0]),len(np.where(Y_te==2.)[0]),len(np.where(Y_te==3.)[0]),len(np.where(Y_te==4.)[0])])
